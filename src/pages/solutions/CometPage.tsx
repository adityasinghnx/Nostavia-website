...
export const CometPage: React.FC = () => {
    ...
    <div className="flex flex-col gap-20 py-10 font-body text-[#0F172A] bg-white">
      ...
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 w-full pt-4">
        <div className="p-8 sm:p-14 lg:p-16 bg-white border border-[#E2E8F0] rounded-[2px] space-y-8 shadow-none relative overflow-hidden">
          ...
          <div className="eyebrow text-[#64748B] font-bold text-xs uppercase tracking-widest font-mono">
            SPECIALISED SERVICE #1 — SMART REPORT AS A SERVICE
          </div>
          ...
          <h1 className="font-display font-extrabold text-4xl sm:text-6xl lg:text-7xl text-[#0F172A] tracking-tight max-w-4xl leading-[1.02]">
            Replace 20 minutes of pathologist review per lab panel automatically.
          </h1>

          <p className="text-base sm:text-xl text-[#64748B] max-w-3xl leading-relaxed font-body">
            The comprehensive interpretation a pathologist or clinician would spend 20 minutes writing, generated automatically for every routine panel and delivered under your laboratory's brand in PDF, web portal, or mobile app formats.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 pt-8 border-t border-[#E2E8F0] font-mono text-xs text-[#0F172A]">
            <div>
              <div className="font-display text-2xl sm:text-3xl font-extrabold text-[#0F172A]">20 Mins</div>
              <div className="text-[#64748B] font-semibold mt-1">Review Time Replaced</div>
            </div>
            <div>
              <div className="font-display text-2xl sm:text-3xl font-extrabold text-[#0F172A]">&lt;800ms</div>
              <div className="text-[#64748B] font-semibold mt-1">Report Generation Latency</div>
            </div>
            <div>
            ...
            <div>
              <div className="font-display text-2xl sm:text-3xl font-extrabold text-[#0F172A]">100%</div>
              <div className="text-[#64748B] font-semibold mt-1">White-Labeled PDF & Web</div>
            </div>
          </div>
      ...
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 w-full space-y-10">
        <div className="space-y-3">
          ...
          <h2 className="font-display font-extrabold text-4xl sm:text-5xl text-[#0F172A] tracking-tight">
            How Smart Report as a Service operates
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-8 bg-[#F8FAFC] border border-[#E2E8F0] rounded-[2px] space-y-4 hover:border-[#CBD5E1] transition-all">
            ...
            <p className="text-sm text-[#64748B] leading-relaxed font-body">
              Ingests raw lab PDFs or LIS JSON streams, extracting values with 99.4% accuracy across standard & custom panel formats.
            </p>
          </div>
          ...
          <div className="p-8 bg-[#F8FAFC] border border-[#E2E8F0] rounded-[2px] space-y-4 hover:border-[#CBD5E1] transition-all">
            ...
            <h3 className="font-display font-extrabold text-2xl text-[#0F172A]">
              Whole-Body Correlation
            </h3>
            <p className="text-sm text-[#64748B] leading-relaxed font-body">
              Decodes 100+ biomarkers, classifying optimal ranges vs standard laboratory reference bounds and mapping cross-organ interactions.
            </p>
          </div>
          ...
          <div className="p-8 bg-[#F8FAFC] border border-[#E2E8F0] rounded-[2px] space-y-4 hover:border-[#CBD5E1] transition-all">
            ...
            <p className="text-sm text-[#64748B] leading-relaxed font-body">
              Delivers branded, clinician-validated Smart Reports back to your lab portal or directly to patient mobile apps.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 w-full space-y-10">
        ...
        <div className="space-y-4 max-w-4xl">
          {[
            {
              q: "Can we customize the PDF design with our laboratory logo and colors?",
              a: "Yes. Smart Reports are 100% white-labeled. We configure your lab logo, brand colors, custom disclaimers, and pathologist sign-off blocks during setup."
            },
            {
              q: "How does pricing work for Smart Report as a Service?",
              a: "Smart Reports are billed on a simple per-report consumption model with tiered volume discounts for high-throughput diagnostic networks."
            }
          ].map((faq, idx) => (
      ...
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 w-full pt-4">
        <div className="p-12 sm:p-16 lg:p-20 bg-[#0F172A] text-white rounded-[2px] border border-[#1E293B] shadow-2xl text-center flex flex-col items-center gap-8">
          <h2 className="font-display font-extrabold text-4xl sm:text-5xl lg:text-[54px] text-white max-w-4xl leading-[1.05] tracking-tight">
            Launch Smart Reports for your diagnostic network
          </h2>
