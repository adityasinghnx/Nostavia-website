...
export const ClinicsPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-20 py-10 font-body text-[#0F172A] bg-white">
      ...
      <FaqSection
        title="Everything clinic directors ask us"
        description="Learn how Nostavia integrates into clinical workflows, customizes biomarker targets, and safeguards clinician oversight."
        faqs={[
          {
